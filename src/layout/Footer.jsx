...
const Footer = () => {
  const socialLinks = [
    ...
    },
    {
      ...
      icon: <InstagramIcon className="w-20 h-20" />,
    },
  ];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="text-center sm:text-left">
              ...
              <div className="flex justify-center sm:justify-start items-center gap-4 md:gap-5">
                {socialLinks.map((item, i) => (
                  <a
                   ...
                   w-9 h-9 sm:w-8 sm:h-8 md:w-10 md:h-10
                   transition-transform duration-300 hover:scale-110"
                    style={{
                      marginLeft: i === 0 ? 0 : '-4px', // ✅ slight overlap, no gap
                    }}
                  >
