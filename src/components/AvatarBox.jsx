...
const AvatarBox = ({
  name = "Jenny Watson",
  description = "Hi! beautiful people. I`m an author of this blog. Read our post - stay with us"
}) => {
  return (
    <div
      className={`bg-[${Theme.colors.background}] flex flex-col items-center p-4 h-auto max-w-lg sm:max-w-sm md:max-w-md mx-auto `}
      style={{ borderRadius: 0 }} // Sharp edges container
    >
      {/* Avatar */}
      <div className="w-36 h-36 overflow-hidden mb-5" style={{ borderRadius: 0 }}>
        <img
          src={IMAGES.TESTIMONIAL1}
          alt="Avatar"
          className="w-full h-full object-cover"
          style={{ borderRadius: 100}} // Sharp edges image
        />
      </div>

      {/* Name */}
      <p
        className="font-bold mb-2 text-center text-xl sm:text-2xl md:text-3xl"
      ...
      {/* Description */}
      <p
        className="text-center mb-4 text-sm sm:text-base md:text-lg leading-relaxed px-2"
        style={{ color: Theme.colors.darkText }}
      >
        {description}
      </p>
      ...
      <div className="flex gap-4 mt-auto mb-4">
        ...
        {/* Pinterest */}
        <a href="#" className="hover:scale-110 transition-transform" aria-label="Pinterest">
          <svg
            width="35"
            height="35"
            viewBox="0 0 24 24"
