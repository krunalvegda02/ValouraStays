        ...
        <div className='section-container px-4 sm:px-6 lg:px-20'>
            <div className={`w-full bg-[${Theme.colors.background}] p-4 sm:p-6 my-10`}>
                <div className='flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-0'>
                    <span className={`font-serif text-xl sm:text-2xl lg:text-3xl text-center sm:text-left text-[${Theme.colors.text}]`}>
                    ...
                    >
                        <span className='ttext-base sm:text-md md:text-lg'>Send Message</span>
                    </Button>
                </div>
            </div>
        </div>
